...
export default function Pagination({ count }: { count: number | undefined }) {
    ...
    return (
        <div className='flex items-center gap-[10px]'>
            <Button variant="text" onClick={() => handleChangePage("prev")} className='border'>Prev</Button>
            <Button variant="text" onClick={() => handleChangePage("next")} className='border'>Next</Button>
        </div>
    )
}
